    ...
    def __call__(self):
        ...
        try:
            ...
            for task in tasks:
                ...
                instance = PerformanceCollectionHandler.get_instance(self.ctx, task_id)
                # convert to a  message
                LOG.info('Naju  Triggering addJob')
                self.task_rpcapi.addJob1(self.ctx, 'message', task_id)
                LOG.info("Naju Posted message")
