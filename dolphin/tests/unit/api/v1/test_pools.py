...
from dolphin.api.v1.pools import PoolController
...
class TestStoragePoolController(test.TestCase):
    ...
    def test_list(self):
        self.mock_object(
            db, 'pool_get_all',
            fakes.fake_storage_pools_get_all)
        req = fakes.HTTPRequest.blank('/pools')
    ...
    def test_list_with_filter(self):
        ...
        req = fakes.HTTPRequest.blank(
            '/pools/?storage_id=12c2d52f-01bc-41f5-b73f-7abf6f38a2a6&sort=name:asc&wrongfilter=remove')
        res_dict = self.controller.index(req)
        expctd_dict = {
            "pools": [
                {
    ...
    def test_show(self):
        self.mock_object(
            db, 'pool_get',
            fakes.fake_pool_show)
        req = fakes.HTTPRequest.blank(
            '/pools/14155a1f-f053-4ccb-a846-ed67e4387428')
    ...
    def test_show_with_invalid_id(self):
        ...
        req = fakes.HTTPRequest.blank('/pools/fake_id')
