...
pool = {
    "id" : "b8821686-88a6-4641-9f09-c21ec4fb3494_pool",
    "name" : "pool1",
    "storage_id": "b8821686-88a6-4641-9f09-c21ec4fb3494",
    "original_id" : "1234567",
...
volume = {
	"id" : "b8821686-88a6-4641-9f09-c21ec4fb3494_volume",
    "name" : "volume1",
    "storage_id" : "b8821686-88a6-4641-9f09-c21ec4fb3494",
    "original_pool_id" : "1234567",
    "description" :"abcd",
    "status" : "Available",
    "original_id": "b8821686-88a6-4641-9f09-c21ec4fb3494",
    "wwn" : "b8821686-88a6-4641-9f09-c21ec4fb3494",
...
def main():
    ...
    db.volume_create(context, volume)
    volume_all = db.volume_get_all(context, None, None, None, None, None)
    for v in volume_all:
        print(v.to_dict())
